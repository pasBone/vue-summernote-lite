...
(function (global, factory) {
            ...
            children: [
                button({
                    ...
                    callback: function ($button) {
                        ...
                        if (type !== 'foreColor') {
                            $recentColor.css('border-color', '#FFFF00');
                ...
                dropdown({
                    ...
                    click: function (event) {
                        ...
                        if (eventName && value) {
                            var key = eventName === 'backColor' ? 'border-color' : 'color';
    ...
    var dialog = renderer.create('<div class="note-modal" aria-hidden="false" tabindex="-1" role="dialog"/>', function ($node, options) {
        ...
        $node.html([
            '  <div style="width:' + options.modalWidth + '" class="note-modal-content">' +
            (options.title
    ...
    function createImage(url) {
        return $$1.Deferred(function (deferred) {
            var $img = $$1('<img class="summernote-img">');
    ...
    */
    ...
    var Editor = /** @class */ (function () {
        ...
        Editor.prototype.insertImage = function (src, param) {
            ...
            return createImage(src, param).then(function ($image) {
                ...
                pTag.appendChild($image[0]);
                range.create(_this.editable).insertNode(pTag);
                range.createFromNodeAfter(pTag).select();
                _this.afterCommand();
            }).fail(function (e) {
    ...
    var Buttons = /** @class */ (function () {
        ...
        Buttons.prototype.addToolbarButtons = function () {
            ...
            this.context.memo('button.justifyLeft', justifyLeft);
            this.context.memo('button.justifyCenter', justifyCenter);
            this.context.memo('button.justifyRight', justifyRight);
            this.context.memo('button.justifyFull', justifyFull);
            this.context.memo('button.outdent', outdent);
            this.context.memo('button.indent', indent);
                ...
                return _this.ui.buttonGroup([
                    ...
                    _this.ui.dropdown([
                        _this.ui.buttonGroup({
                            className: 'note-align',
                            // children: [ justifyCenter, justifyRight, justifyFull]
                        }),
                        _this.ui.buttonGroup({
                            className: 'note-list',
        ...
        Buttons.prototype.updateCurrentStyle = function ($container) {
            ...
            if (styleInfo['font-family']) {
                ...
                $cont.find('.note-current-fontname').text(fontName_1).css('font-family', fontName_1).parent('button').css({
                    'width': ' 86px',
                    'overflow': 'hidden',
    ...
    var LinkDialog = /** @class */ (function () {
        ...
        LinkDialog.prototype.initialize = function () {
            ...
            var body = [
                ...
                "<label class=\"note-form-label\"><i class=\"fa fa-font\" aria-hidden=\"true\"></i></label>",
                '<input placeholder="' + this.lang.link.textToDisplay + '" class="note-link-text form-control note-form-control  note-input" type="text" />',
                '</div>',
                '<div class="form-group note-form-group">',
                "<label class=\"note-form-label\"><i class=\"fa fa-link\" aria-hidden=\"true\"></i></label>",
                '<input placeholder="' + this.lang.link.url + '" class="note-link-url form-control note-form-control note-input" type="text" value="http://" />',
                '</div>',
    ...
    var ImageDialog = /** @class */ (function () {
        ...
        ImageDialog.prototype.initialize = function () {
            ...
            var body = '<div class="note-form-group note-group-select-from-files">' +
                '<form id="summernote-img-form" enctype="multipart/form-data"><label>'+ this.lang.image.image +'<input id="summernote-choose-img" style="display: none;" class="note-image-input note-input" type="file" name="files" accept="image/*" multiple="multiple" /></label></div></form>' +
                '<p style="margin-bottom: 14px; text-align: center;">或</p><div class="form-group note-form-group"><label class=\"note-form-label\"><i class=\"fa fa-link\" aria-hidden=\"true\"></i></label>' +
                '<input placeholder="请输入网络图片链接" style="width: 270px;" class="note-image-url form-control note-form-control note-input type="text" /></div>';
    ...
    var VideoDialog = /** @class */ (function () {
        ...
        VideoDialog.prototype.initialize = function () {
            var $container = this.options.dialogsInBody ? this.$body : this.$editor;
            var body = '<div class="note-form-group note-group-select-from-files">' +
                '<form id="summernote-video-form" enctype="multipart/form-data"><label>点击上传<input id="summernote-choose-video" style="display: none;" class="note-video-input note-input" type="file" name="files"/></label></div></form>' +
                '<p style="margin-bottom: 14px; text-align: center;">或</p><div class="form-group note-form-group"><label class=\"note-form-label\"><i class=\"fa fa-link\" aria-hidden=\"true\"></i></label>' +
                '<input placeholder="请输入网络图片链接" style="width: 250px;" class="note-video-url form-control note-form-control note-input type="text" /></div>';
        ...
        VideoDialog.prototype.showVideoDialog = function (text) {
            ...
            return $$1.Deferred(function (deferred) {
                ...
                var $videoInput = _this.$dialog.find('#summernote-choose-video');

                $videoInput.replaceWith($videoInput.clone().on('change', function (event) {
                    // deferred.resolve(event.target.files || event.target.value);
                    var callbacks = _this.options.callbacks;
                    callbacks.onVideoUpload(event.target.files || event.target.value).then((url)=>{
    ...
    $$1.summernote = $$1.extend($$1.summernote, {
        ...
        options: {
            ...
            fontNames: [
                '微软雅黑', '宋体', '楷体', '黑体', '隶书', 'Arial', 'Arial Black', 'Comic Sans MS', 'Courier New',
                'Helvetica Neue', 'Helvetica', 'Impact', 'Lucida Grande',
                'Tahoma', 'Times New Roman', 'Verdana'
            ],
            fontSizes: ['8', '9', '10', '11', '12', '14', '18', '24', '32', '36', '48'],
